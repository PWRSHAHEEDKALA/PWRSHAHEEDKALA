...
# --- Configuration ---
TOKEN = '7748948464:AAEiy20bvKElGYJ3qRsyt86JcxzGXNGIDE0' # Replace with your actual token
OWNER_ID = 5112593221 # Replace with your Owner ID
ADMIN_ID = 5112593221# Replace with your Admin ID (can be same as Owner)
YOUR_USERNAME = '@Aruu_second' # Replace with your Telegram username (without the @)
UPDATE_CHANNEL = 'https://t.me/Aruu_second' # Replace with your update channel link
...
# File upload limits
FREE_USER_LIMIT = 0
SUBSCRIBED_USER_LIMIT = 0 # Changed from 10 to 15
ADMIN_LIMIT = 999       # Changed from 50 to 999
OWNER_LIMIT = float('inf') # Changed from 999 to infinity
# FREE_MODE_LIMIT = 0 # Removed as free_mode is removed
